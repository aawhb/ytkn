...
YT Knowledge Notes is built around one command: paste YouTube URLs, choose the note shape, and let the queue write Markdown into your vault.

## Commands

The plugin registers these commands under **YT Knowledge Notes** in the Obsidian command palette:
