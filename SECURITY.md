...
YT Knowledge Notes stores provider API keys in the plugin `data.json` file inside your local vault. The plugin does not encrypt this file, proxy requests through a server, or collect telemetry.
