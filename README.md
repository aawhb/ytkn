...
YT Knowledge Notes (ytkn) turns YouTube videos and playlists into structured Obsidian notes: transcript-first, AI-optional, template-driven, and vault-native.
...
3. Reload Obsidian and enable **YT Knowledge Notes**.

ytkn is distributed through GitHub Release assets rather than npm. Each release also includes `ytkn-release.sha256` and `ytkn-release.sigstore.json` for checksum verification and provenance.
...
4. Reload Obsidian and enable **YT Knowledge Notes**.
