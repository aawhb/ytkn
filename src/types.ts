...
export type TranscriptMode = 'none' | 'raw' | 'readable' | 'timestamped';
...
export type RunReportLocation = 'first-note' | 'separate-note';
export type ReasoningMode = 'off' | 'on' | 'provider-default';
