...
export const DEFAULT_FRONTMATTER_PROPERTY_ALLOWLIST = 'title aliases source channel channelUrl channelId videoUrl playlistUrl videoId playlistId thumbnailUrl videoDescription uploadDate videoCategory durationSeconds keywords generated videoCount';
export const DEFAULT_SOURCE_SECTION_POSITION = 'bottom';

export const DEFAULT_OUTPUT_TRANSCRIPT_MODE = 'timestamped';
export const DEFAULT_LINK_TIMESTAMPS = true;
...
export const DEFAULT_INCLUDE_MINDMAP = true;
export const DEFAULT_INCLUDE_MEMORABLE_QUOTES = true;
